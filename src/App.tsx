...
import { logout, processarPdf, usuarioAtual, SessaoExpirada, type Resposta, type UsuarioSessao } from "./api"
import { AppShell, type PaginaApp } from "./components/AppShell"
...
export default function App() {
  ...
  const [usuario, setUsuario] = useState<UsuarioSessao | null | undefined>(undefined)
  const [pagina, setPagina] = useState<PaginaApp>("ingestao")
  ...
  return (
    <>
      ...
      >
        ...
        {pagina === "historico" && <HistoryPage />}
        {pagina === "usuarios" && usuario.papel === "admin" && <UsersPage sessao={usuario} />}
      </AppShell>
      {dados && (
        <ConferenciaModal
          open={conferindo}
